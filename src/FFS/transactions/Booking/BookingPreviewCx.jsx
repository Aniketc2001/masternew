import { Grid, Box, Paper, TextField, Stack } from '@mui/material';
...
export default function BookingPreviewCx(props) {
  ...
  const getinitialVal = () => {
    try {
      axios({
        ...
        if(x.DestinationETA !== ' '){
          x.DestinationETA = getFormattedDate(new Date(x.DestinationETA));
        }  
        setbaseObj(x);
  ...
  return (
    <>
      {
        baseObj ?
          <Box sx={{ maxHeight: `${props.outerHeight ? props.outerHeight : '65vh'}`, }}>
              ...
              <Grid container spacing={1}>
                <Grid item xs={12} sx={{ marginBottom: 1 }}>
                  <Stack direction='row' justifyContent='space-between'>
                    ...
                    {
                      props.closeIcon ?
                        <i class="bi bi-x-circle" onClick={() => props.setProp(false)} style={{ fontSize: '13pt', cursor: 'pointer' }}></i>
                        :
                        <></>
                    }
                  </Stack>
                </Grid>
                <Box sx={{ maxHeight: `${props.height ? props.height : '60vh'}`, overflow: 'auto', p: 1 }}>
                  <Grid item xs={12}>
                  ...
                  <Grid item xs={12}>
                    ...
                    <Grid container spacing={1}>
                      <Grid item xs={12}>
                        <TextField className='mui-custom-textfield' variant='standard' fullWidth label="Booking" value={baseObj.CustomerName} />
                      </Grid>
                      <Grid item xs={4}>
                    ...
                    <Box sx={{ marginTop: 1 }}>
                      ...
                      <Grid container spacing={1}>
                        ...
                        <Grid item xs={12}>
                          <TextField variant='standard' className='mui-custom-textfield' inputProps={{ readOnly: true }} fullWidth label="Service Contract Number" value={baseObj.LineServiceContractNumber} />
                        </Grid>
                        <Grid item xs={12}>
