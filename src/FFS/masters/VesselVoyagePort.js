...
export default function VesselVoyagePort() {
        ...
        vl.then((dialogResult) => {
            if (dialogResult) {
                ...
                axios({
                    ...
                    setnotificationBarMessage("Vessel Voyage Port details saved successfully!");
                    ...
                    if (error.response) {
                        ...
                        alert("Error occured while saving data.." + error.response.data, "Save Errors");
                    }
                })
            }
        });
                ...
                axios({
                    ...
                    if (error.response) {
                        if (error.response.status === 417) {
                            alert("Error occured while deleting data.." + error.response.data, "Delete Errors");
                        }
                    }
                })
            }
        ...
        <>
            <Box>
                ...
                >{ }
                    ...
                    <p className='PageSubTitle'>Manage vessel voyage and port information</p>
                    <Grid container>
                        <Grid item xs={12} marginTop={3} margingBottom={4}>
