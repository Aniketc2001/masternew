...
`
export default function CheckerOutbox() {
  ...
  return (
          <>
            <Typography variant="h6" style={{display: 'inline-block', marginRight:10}}>My Requests awaiting approval</Typography>
              ...
              <TableBody>
                  {CheckerQueues.map((chkrQ) => (
                      <TRow key={chkrQ.CheckerQueueId}>
                        ...
                        <TableCell>
                          <Button color="primary" variant="contained" style={{marginRight:10, height: 15}} component={Link} to={`/${chkrQ.DataUrl}&clr=m`}>Check</Button>
                        </TableCell>
                      </TRow>
                  ))}
              </TableBody>
